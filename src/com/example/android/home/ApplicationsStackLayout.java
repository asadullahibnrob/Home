...
public class ApplicationsStackLayout extends ViewGroup implements View.OnClickListener {
    ...
    public ApplicationsStackLayout(Context context, AttributeSet attrs) {
        ...
        a.recycle();
//*****************************************************************************************************till readyxml
        mIconSize = 122; //(int) getResources().getDimension(android.R.dimen.app_icon_size);
...
// this is the method that sets the icons next to the allapps button increase setbounds and miconsize to 
