...
public class Home extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        bindRecents();
         ...
         // the following loads animation from xml in anim
        mGridEntry = AnimationUtils.loadAnimation(this, R.anim.slide_up_from_bottom);
        mGridExit = AnimationUtils.loadAnimation(this, R.anim.slide_out);
    }
    ...
    private void setDefaultWallpaper() {
        if (!mWallpaperChecked) {
           // Drawable wallpaper = peekWallpaper();
            Drawable wallpaper = WallpaperManager.getInstance(getApplicationContext()).peekDrawable();
...
//        mGrid.startLayoutAnimation();
    ...
    //made this so that when you click on the app you don't return to the open grid view
    private void hideAppsLeaving(){
    	mGrid.setVisibility(View.INVISIBLE);
    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!info.filtered) {
                ...
                if (width > 0 && height > 0 && (width < iconWidth || height < iconHeight)) {
                    ...
                    icon = info.icon = new BitmapDrawable(getApplication().getResources(),thumb);
                    info.filtered = true;
                }
            }
